...
Interfaz, estilos y lógica de la aplicación.

actualizar-base.sql

Extensión de la tabla existente y función de guardado con control de versiones.
...
Fecha del registro, única por día.

par_estado, impar_estado

Estados en texto; permiten valores nulos.

par_detalle, impar_detalle

Detalles en texto; permiten valores nulos.
...
En el ascensor correspondiente, presioná Agregar registro.

Elegí el estado y completá la hora, el piso y la observación según corresponda.

Presioná Listo para incorporar el registro al borrador del día.

Presioná Guardar cambios para guardarlo en Supabase.
...
Observación de funcionamiento; no cuenta como incidente.

FS

Rojo

Código de incidente FS.
...
Código EE, conservado tal como aparece en el ascensor.

Otro

Gris

Incidente con descripción libre.
